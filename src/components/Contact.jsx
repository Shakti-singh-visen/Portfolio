  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0a0a0a] w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-gray-900">
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        <div 
          data-aos="fade-up"
          className="bg-[#ff2a2a] w-full md:w-[85%] lg:w-[75%] p-8 md:p-16 text-white flex flex-col justify-between rounded-t-[2.5rem] md:rounded-l-[4.5rem] md:rounded-tr-none shadow-[0_-30px_80px_rgba(255,42,42,0.3)] border-t border-l border-white/20"
        >
              ...
              <div className="flex-1 flex flex-col">
                <div className="relative h-full flex flex-col">
                  <textarea 
                    ...
                    required
                    className="w-full h-full min-h-[120px] bg-transparent border-b border-white/40 pb-3 text-lg focus:outline-none focus:border-white transition-all duration-300 focus:pl-2 placeholder-white/80 focus:placeholder-white font-medium resize-none rounded-none"
                  ></textarea>
                </div>
              </div>
            </div>
